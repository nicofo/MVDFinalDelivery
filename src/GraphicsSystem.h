...
public:
	...
	int renderEntityToTexture(int entity_id);

	int renderEntityToTexture(int entity_id, lm::vec4 background_color);
...
private:
	...
	void bindAndClearScreen_(lm::vec4 cc);
